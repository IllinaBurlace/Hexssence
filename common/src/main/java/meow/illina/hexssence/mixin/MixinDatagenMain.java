...
public abstract class MixinDatagenMain {
    ...
    private static void hexssence$systemExitAfterDatagenFinishes(String[] strings, Operation<Void> original) {
        try {
            original.call((Object) strings);
        } catch (Throwable throwable) {
            Hexssence.LOGGER.error("Datagen failed!", throwable);
            System.exit(1);
        }
        Hexssence.LOGGER.info("Datagen succeeded, terminating.");
        System.exit(0);
    }
}
