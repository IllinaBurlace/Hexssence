...
abstract class HexssenceModDependenciesExtension(private val project: Project) {
...
val extension = extensions.create<HexssenceModDependenciesExtension>("hexssenceModDependencies")
