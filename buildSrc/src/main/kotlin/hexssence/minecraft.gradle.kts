...
loom {
    ...
    accessWidenerPath = project(":common").file("src/main/resources/hexssence.accesswidener")

    mixin {
        // the default name includes both archivesName and the subproject, resulting in the platform showing up twice
        // default: hexssence-common-common-refmap.json
        // fixed:   hexssence-common.refmap.json
