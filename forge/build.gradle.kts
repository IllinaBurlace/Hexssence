...
loom {
    forge {
        ...
        mixinConfig(
            "hexssence-common.mixins.json",
            "hexssence-forge.mixins.json",
        )
    }
    ...
    runs {
        for ((platform, outputProject) in arrayOf(
            ...
            register("${platform}Datagen") {
                ...
                property("hexssence.apply-datagen-mixin", "true")
                property("hexssence.$platform-datagen", "true")
            }
        }
    }
}

hexssenceModDependencies {
